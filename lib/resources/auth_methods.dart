...
import 'package:car_rental_a7md/models/user.dart' as model;
...
class AuthMethods {
  ...
  Future<String> signUpUser({
    ...
    try {
      if (email.isNotEmpty && fullName.isNotEmpty && password.isNotEmpty) {
        if (age < 16) {
          res = 'Sorry, your age must be greater than 15.';
        } else {
  ...
  Future<void> resendVerificationEmail(BuildContext context) async {
    try {
      ...
      // Ensure the user is signed in and email is not verified
