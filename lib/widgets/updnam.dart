...
@immutable
class Updnam extends StatefulWidget {
  final String? name;
  ...
  @override
  State<Updnam> createState() => _UpdnamState();
}

class _UpdnamState extends State<Updnam> with WidgetsBindingObserver {
  late TextEditingController _mailController;

  @override
  void initState() {
    super.initState();
    _mailController = TextEditingController(text: widget.name);
  }
